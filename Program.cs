namespace Statball
{
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Directory.CreateDirectory("Results");//result directory creation
            ...
            statReader.ScoutPlayer(File.ReadAllLines("Profiles/ST.txt"), playerName: "", count: 50, position: "FW", LeagueFilter: "", TeamFilter: "", ageFilter: 99, minimumFilter: 20, outputFile: "Results/Best_STs.csv");
            statReader.ScoutPlayer(File.ReadAllLines("Profiles/CB.txt"), playerName: "", count: 30, position: "DF", LeagueFilter: "", TeamFilter: "", ageFilter: 30, minimumFilter: 15, outputFile: "Results/Best_CBs.csv");
