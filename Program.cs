namespace Statball
{
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            statReader.ScoutPlayer(File.ReadAllLines("Profiles/DM.txt"), playerName: "", count: 20, position: "MF", LeagueFilter: "eng", TeamFilter: "", ageFilter: 30, minimumFilter: 20, outputFile: "Results/Best_u30_DMs_EPL.csv");
